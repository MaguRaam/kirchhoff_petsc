...
PetscErrorCode GetPressureOnSurface(Vec U, DM da, AppCtx* Ctx, PetscInt step){
    ...
    sprintf(filename_curved, "kirchhoff/input/curved/p-%09d.dat", step); 
    ...
    sprintf(filename_top, "kirchhoff/input/top/p-%09d.dat", step); 
    ...
    sprintf(filename_bottom, "kirchhoff/input/bottom/p-%09d.dat", step); 
